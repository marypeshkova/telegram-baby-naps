...
function Slider() {
  return (
    <div className="absolute left-[34px] top-[93px] w-[370px]">
      ...
      <div className="absolute top-0 left-0 h-[6px] w-[58px] bg-gradient-to-r from-purple-400 to-purple-300 rounded-full"/>
    </div>
  );
}
...
export default function Screen01({ onNext, onDateChange, selectedDate }: Screen01Props) {
  ...
  return (
    <div className="bg-[#191838] relative w-full h-screen overflow-hidden">
      ...
      <button
        className="absolute left-[20px] top-[710px] w-[387px] h-[78px] bg-[#252352] rounded-[12px] flex items-center justify-center cursor-pointer hover:bg-[#2d2a5d] transition-colors"
      ...
      {isCalendarOpen && (
        <>
          ...
          <div className="fixed bottom-0 left-0 right-0 bg-[#1a1a2e] rounded-t-[20px] z-50 animate-slide-up pb-8">
            <div className="px-4 py-3">
              ...
              <div className="flex justify-between items-center mb-4">
                ...
                <button
                  onClick={() => setIsCalendarOpen(false)}
                  className="text-[#babbff] font-medium text-[17px] px-4"
                >
                  Добавить
                </button>
              </div>
              ...
              <div className="py-4">
                ...
                <div className="flex justify-between items-center mb-6 px-4">
                  <button
                    ...
                    className="text-[#babbff] text-[24px] px-2"
                  >
                    ←
                  </button>
                ...
                <div className="px-2">
                  <div className="grid grid-cols-7 gap-1 mb-2">
                    {["ПН", "ВТ", "СР", "ЧТ", "ПТ", "СБ", "ВС"].map((day) => (
                      <div key={day} className="text-center text-gray-500 text-[12px] py-2">
                        {day}
                      </div>
                    ))}
                  </div>
